...
const PropertyDetail = () => {
    ...
    useEffect(() => {
        const fetchDetailProperty = async () => {
            try {
                ...
                const imageProperty = await getImagesByPropertyId(
                    detalProperty._id
                );
                if (user) {
                ...
                const dataProperty = {
                    ...
                    additionalImages:
                        imageProperty[0]?.additionalImages || null,
                };
    ...
    const handlePreviousImage = () => {
        if (property?.additionalImages) {
            const newIndex =
                (currentImageIndex - 1 + property.additionalImages.length) %
                property.additionalImages.length;
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex items-center gap-4 justify-between">
                            ...
                            <div className="flex gap-4 overflow-x-auto scrollbar-hide px-2">
                                {property?.additionalImages.map(
                                    (image, index) => (
                                        <div
                                            key={index}
                                            className={`relative group w-20 h-20 sm:w-24 sm:h-24 flex-shrink-0 border-2 rounded-lg overflow-hidden cursor-pointer transition-all duration-300 ${
                                                mainImage === image
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                className={`mt-2 px-4 py-2 rounded-lg shadow flex items-center justify-center ${
                                    isFavorite
                                        ? "text-red-500"
                                        : "text-gray-500"
                                }`}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                    ...
                    <div className="bg-white p-6 shadow-lg rounded-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
                        ...
                        <button
                            ...
                            onClick={() =>
                                (window.location.href = "tel:01054243939")
                            }
                        >
                            연락하기
                        </button>
